; TTL demo
; User selects TTL threshold/config using switches 0 and 1.
; The program samples the ADC channel 0 using the peripheral in TTL mode, displaying
; the signed mV difference on the right hex displays.
; Additionally, setting SW9 high sets IO mode bits to 11, which is invalid.
; The peripheral returns 0xDEAD and the program displays it on the right hex displays.
